...
class MetadataInconsistent(InstallationError):
    ...
    def __str__(self) -> str:
        return f"Requested {self.ireq} has inconsistent {self.field}: " f"expected {self.f_val!r}, but metadata has {self.m_val!r}"
...
class UninstallMissingRecord(DiagnosticPipError):
    ...
    def __init__(self, *, distribution: "BaseDistribution") -> None:
        ...
        if not installer or installer == "pip":
            ...
            hint = Text(f"The package was installed by {installer}. " "You should check if it can uninstall the package.")
