                ...
                if cls is Protocol:
                    ...
                    if not all(isinstance(p, typing.TypeVar) for p in params):
                        ...
                        while isinstance(params[i], typing.TypeVar):
                            i += 1
                        raise TypeError("Parameters to Protocol[...] must all be type variables." f" Parameter {i + 1} is {params[i]}")
        ...
        *,
        ...
        def decorator(__arg: _T) -> _T:
            if category is None:
                ...
                raise TypeError("@deprecated decorator with non-None category must be applied to " f"a class or callable, not {__arg!r}")
