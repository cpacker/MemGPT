...
Do not stop reorganizing memories until you are confident that the new memory block is a better representation, come up with new relationships that can be inferred based on existing relations between entities.
Use each step to come up with more relationships and inferences that can be made based on the new information and the existing information in the memory block.
"""

TREE_EXAMPLE = """
Alice is a child of John
Alice is a child of Mary
Carol is a child of Alice
Emily is a child of Carol
Frank is a child of Carol
Dave is a child of Alice
Dave is a child of Bob
Dave is a child of Alice
Dave is a child of Bob
Jessy is a child of Dave
Kate is a child of Dave
Penny is a child of Dave
...
Kate is a child of Dave
Penny is a child of Dave
Rachel is a child of Perry
Rachel is a child of Quincy
Jocelyn is a child of Rachel
Kyle is a child of Rachel
Kyle is a child of Sam
Luke is a child of Rachel
Luke is a child of Sam
Molly is a child of Rachel
Molly is a child of Sam
Nancy is a child of Rachel
Nancy is a child of Sam
Sam is a child of Perry
Sam is a child of Quincy
Kyle is a child of Sam
Kyle is a child of Rachel
Luke is a child of Sam
Luke is a child of Rachel
...
TREE_UPDATES = ["Kyle and Emily got married"]
TREE_EXAMPLE_QUESTION = "What is the relationship between Luke and Carol?"


def run_memory_edits(offline_memory: bool):
    ...
    if not offline_memory:
        ...
        for requested_rewrite in TREE_UPDATES:
            response = client.send_message(message=requested_rewrite, role="user", agent_id=conversation_agent.id)

        client.send_message(message=TREE_EXAMPLE_QUESTION, role="user", agent_id=conversation_agent.id)
...
if __name__ == "__main__":
    ...
    run_memory_edits(args.offline_memory)
