...
def parse_editable(editable_req: str) -> Tuple[Optional[str], str, Set[str]]:
    ...
    if not package_name:
        raise InstallationError(
            "Could not detect requirement name for '{}', please specify one " "with #egg=your_package_name".format(editable_req)
        )
...
def check_first_requirement_in_file(filename: str) -> None:
    ...
    with open(filename, encoding="utf-8", errors="ignore") as f:
        ...
        lines = (line for line in (line.strip() for line in f) if line and not line.startswith("#"))  # Skip blank lines/comments.
