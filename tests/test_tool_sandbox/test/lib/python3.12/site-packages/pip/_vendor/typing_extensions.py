...
if sys.version_info >= (3, 13, 0, "beta"):
    ...
    ContextManager = _SpecialGenericAlias(contextlib.AbstractContextManager, 2, name="ContextManager", defaults=(typing.Optional[bool],))
...
# 3.8
    ...
    class _AnnotatedAlias(typing._GenericAlias, _root=True):
        ...
        def __repr__(self):
            return f"typing_extensions.Annotated[{typing._type_repr(self.__origin__)}, " f"{', '.join(repr(a) for a in self.__metadata__)}]"
...
if _PEP_696_IMPLEMENTED:
    ...
    class TypeVar(metaclass=_TypeVarLikeMeta):
        ...
        def __new__(cls, name, *constraints, bound=None, covariant=False, contravariant=False, default=NoDefault, infer_variance=False):
...
# 3.10+
    ...
    class ParamSpec(metaclass=_TypeVarLikeMeta):
        ...
        def __new__(cls, name, *, bound=None, covariant=False, contravariant=False, infer_variance=False, default=NoDefault):
            if hasattr(typing, "TypeAliasType"):
...
# 3.8-3.9
    ...
    class ParamSpec(list, _DefaultMixin):
        ...
        def __init__(self, name, *, bound=None, covariant=False, contravariant=False, infer_variance=False, default=NoDefault):
    ...
    class deprecated:
        ...
        def __call__(self, arg: _T, /) -> _T:
            ...
            if category is None:
                ...
                raise TypeError("@deprecated decorator with non-None category must be applied to " f"a class or callable, not {arg!r}")
...
if not hasattr(typing, "TypeVarTuple"):
    ...
    def _check_generic(cls, parameters, elen=_marker):
        ...
        if alen != elen:
            ...
            raise TypeError(f"Too {'many' if alen > elen else 'few'} {things}" f" for {cls}; actual {alen}, expected {expect_val}")
    ...
    def _check_generic(cls, parameters, elen):
        ...
        if alen != elen:
            ...
            raise TypeError(f"Too {'many' if alen > elen else 'few'} arguments" f" for {cls}; actual {alen}, expected {expect_val}")
                ...
                if key in _prohibited_namedtuple_fields:
                    ...
                    try:
                        ...
                        try:
                            ...
                            msg = f"Error calling __set_name__ on {type(val).__name__!r} " f"instance {key!r} in {typename!r}"
    ...
    def NamedTuple(typename, fields=_marker, /, **kwargs):
        ...
        if fields is _marker:
            if kwargs:
                ...
                deprecation_msg = (
                    "{name} is deprecated and will be disallowed in Python {remove}. " "Use the class-based or functional syntax instead."
                )
            else:
                deprecated_thing = "Failing to pass a value for the 'fields' parameter"
