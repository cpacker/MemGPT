...
class HtmlFormatter(Formatter):
    ...
    **Subclassing the HTML formatter**
    ...
    def __init__(self, **options):
        ...
        if self.tagsfile:
            if not ctags:
                raise RuntimeError('The "ctags" package must to be installed ' 'to be able to use the "tagsfile" feature.')
        ...
        if self.cssfile:
            if os.path.isabs(self.cssfile):
                ...
                try:
                    ...
                    print(
                        "Note: Cannot determine output file name, " "using current directory as base for the CSS file name", file=sys.stderr
                    )
                    cssfilename = self.cssfile
    ...
    def _wrap_tablelinenos(self, inner):
        ...
        filename_tr = ""
        if self.filename:
            filename_tr = '<tr><th colspan="2" class="filename">' '<span class="filename">' + self.filename + "</span>" "</th></tr>"
