...
class RequirementPreparer:
    ...
    def _prepare_linked_requirement(self, req: InstallRequirement, parallel_builds: bool) -> BaseDistribution:
        ...
        if link.is_existing_dir():
            ...
            try:
                ...
                raise InstallationError(f"Could not install requirement {req} because of HTTP " f"error {exc} for URL {link}")
        else:
    ...
    def prepare_installed_requirement(
        ...
        assert skip_reason is not None, "did not get skip reason skipped but req.satisfied_by " f"is set to {req.satisfied_by}"
