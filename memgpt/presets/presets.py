...
def create_preset_from_file(filename: str, name: str, user_id: uuid.UUID, ms: MetadataStore) -> Preset:
    ...
    preset = Preset(
        ...
        template_data={"system_template": system_preset_dict["template"], "system_template_fields": system_preset_dict["template_fields"],
                       ...
                       "initial_core_memory": core_memory, "core_memory_section_template": preset_config["core_memory_section_template"]},
