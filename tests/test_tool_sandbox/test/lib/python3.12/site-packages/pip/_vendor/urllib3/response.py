...
class HTTPResponse(io.IOBase):
    ...
    def from_httplib(ResponseCls, r, **response_kw):
        ...
        resp = ResponseCls(
            body=r, headers=headers, status=r.status, version=r.version, reason=r.reason, strict=strict, original_response=r, **response_kw
        )
        return resp
    ...
    def read_chunked(self, amt=None, decode_content=None):
        ...
        if not self.supports_chunked_reads():
            raise BodyNotHttplibCompatible(
                "Body should be http.client.HTTPResponse like. " "It should have have an fp attribute which returns raw chunks."
            )
