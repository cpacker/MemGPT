...
def upgrade() -> None:
    ...
    op.create_table('memory_template',
    ...
    sa.ForeignKeyConstraint(['_agent_id'], ['agent._id'], ),
    sa.ForeignKeyConstraint(['_source_id'], ['source._id'], ),
    sa.PrimaryKeyConstraint('_agent_id', '_source_id')
    )
    op.create_table('sources_presets',
    sa.Column('_preset_id', sa.UUID(), nullable=False),
    sa.Column('_source_id', sa.UUID(), nullable=False),
    sa.ForeignKeyConstraint(['_preset_id'], ['preset._id'], ),
    sa.ForeignKeyConstraint(['_source_id'], ['source._id'], ),
    ...
    sa.ForeignKeyConstraint(['_agent_id'], ['agent._id'], ),
    sa.ForeignKeyConstraint(['_tool_id'], ['tool._id'], ),
