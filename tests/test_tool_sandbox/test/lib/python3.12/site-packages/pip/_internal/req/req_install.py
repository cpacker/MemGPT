...
class InstallRequirement:
    ...
    def match_markers(self, extras_requested: Optional[Iterable[str]] = None) -> bool:
        ...
        if self.markers is not None:
            return any(
                ...
                or self.markers.evaluate({"extra": safe_extra(extra)}) or self.markers.evaluate({"extra": canonicalize_name(extra)})
    ...
    def warn_on_mismatching_name(self) -> None:
        ...
        logger.warning(
            "Generating metadata for package %s " "produced metadata for project name %s. Fix your " "#egg=%s fragments.",
            self.name,
            metadata_name,
            self.name,
        )
    ...
    def get_dist(self) -> BaseDistribution:
        ...
        raise AssertionError(f"InstallRequirement {self} has no metadata directory and no wheel: " f"can't make a distribution.")
