...
class SyncServer(Server):
    ...
    def get_agent_recall_cursor(
        ...
        if not return_message_object:
            ...
            if reverse:
                records = [msg for m in records for msg in m.to_letta_message(assistant_message=assistant_message)[::-1]]
            else:
                records = [msg for m in records for msg in m.to_letta_message(assistant_message=assistant_message)]
