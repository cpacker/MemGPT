...
from .base import BaseDistribution, BaseEntryPoint, BaseEnvironment, InfoPath, Wheel
    ...
    def from_wheel(cls, wheel: Wheel, name: str) -> BaseDistribution:
        try:
            with wheel.as_zipfile() as zf:
                ...
                metadata_dict = {
                    path.split("/", 1)[-1]: read_wheel_metadata_file(zf, path) for path in zf.namelist() if path.startswith(f"{info_dir}/")
                }
