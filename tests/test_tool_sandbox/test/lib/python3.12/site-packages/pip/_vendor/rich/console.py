...
class Console:
    ...
    def __init__(
        ...
        *,
        ...
        self.legacy_windows: bool = (detect_legacy_windows() and not self.is_jupyter) if legacy_windows is None else legacy_windows
    ...
    def export_svg(
        ...
        *,
        ...
        def get_svg_style(style: Style) -> str:
            ...
            bgcolor = (
                _theme.background_color if (style.bgcolor is None or style.bgcolor.is_default) else style.bgcolor.get_truecolor(_theme)
            )
            if style.reverse:
        ...
        for y, line in enumerate(Segment.split_and_crop_lines(segments, length=width)):
            ...
            for text, style, _control in line:
                ...
                if style.reverse:
                    has_background = True
                    background = _theme.foreground_color.hex if style.color is None else style.color.get_truecolor(_theme).hex
                else:
                    bgcolor = style.bgcolor
                    has_background = bgcolor is not None and not bgcolor.is_default
                    background = _theme.background_color.hex if style.bgcolor is None else style.bgcolor.get_truecolor(_theme).hex
