...
class Live(JupyterMixin, RenderHook):
    ...
    def refresh(self) -> None:
        ...
        with self._lock:
            ...
            elif not self._started and not self.transient:  # if it is finished allow files or dumb-terminals to see final result
                with self.console:
                    self.console.print(Control())
    ...
    def process_renderables(self, renderables: List[ConsoleRenderable]) -> List[ConsoleRenderable]:
        ...
        elif not self._started and not self.transient:  # if it is finished render the final output for files or dumb_terminals
