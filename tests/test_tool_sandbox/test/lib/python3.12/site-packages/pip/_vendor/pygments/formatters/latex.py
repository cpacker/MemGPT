...
class LatexFormatter(Formatter):
    ...
    def _create_stylesheet(self):
        ...
        for ttype, ndef in self.style:
            ...
            if ndef["border"]:
                cmndef += r"\def\$$@bc##1{{\setlength{\fboxsep}{\string -\fboxrule}" r"\fcolorbox[rgb]{%s}{%s}{\strut ##1}}}" % (
                    rgbcolor(ndef["border"]),
                    rgbcolor(ndef["bgcolor"]),
                )
            elif ndef["bgcolor"]:
                cmndef += r"\def\$$@bc##1{{\setlength{\fboxsep}{0pt}" r"\colorbox[rgb]{%s}{\strut ##1}}}" % rgbcolor(ndef["bgcolor"])
            if cmndef == "":
                continue
