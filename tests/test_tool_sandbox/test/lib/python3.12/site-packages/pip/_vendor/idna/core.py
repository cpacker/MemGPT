    ...
    for pos, cp in enumerate(label):
        ...
        if intranges_contain(cp_value, idnadata.codepoint_classes["PVALID"]):
            ...
            try:
                ...
                raise IDNAError(
                    "Unknown codepoint adjacent to joiner {} at position {} in {}".format(_unot(cp_value), pos + 1, repr(label))
                )
...
def encode(
    s: Union[str, bytes, bytearray], strict: bool = False, uts46: bool = False, std3_rules: bool = False, transitional: bool = False
) -> bytes:
