...
class Resolver(BaseResolver):
    ...
    def resolve(self, root_reqs: List[InstallRequirement], check_supported_wheels: bool) -> RequirementSet:
        ...
        try:
            ...
            result = self._result = resolver.resolve(collected.requirements, max_rounds=limit_how_complex_resolution_can_be)
            ...
            if ireq is None:
                if candidate.name != candidate.project_name:
                    ...
                    with contextlib.suppress(KeyError):
                        ...
                        req_set.add_named_requirement(install_req_extend_extras(req, get_requirement(candidate.name).extras))
                continue
