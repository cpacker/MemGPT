...
def upgrade() -> None:
    ...
    op.create_unique_constraint("uix_sources_name_organization", "sources", ["name", "organization_id"])
...
def downgrade() -> None:
    ...
    op.drop_constraint("uix_sources_name_organization", "sources", type_="unique")
