...
class Criterion(object):
    ...
    * `candidates` is a collection containing all possible candidates deducted
    ...
    def __repr__(self):
        requirements = ", ".join("({!r}, via={!r})".format(req, parent) for req, parent in self.information)
...
class Resolution(object):
        ...
        for key, criterion in criteria.items():
            criteria[key] = Criterion(
                ...
                [
                    ...
                    if (information.parent is None or self._p.identify(information.parent) not in parents)
                ],
    ...
    def resolve(self, requirements, max_rounds):
        ...
        for round_index in range(max_rounds):
            ...
            unsatisfied_names = [
                key for key, criterion in self.state.criteria.items() if not self._is_current_pin_satisfying(key, criterion)
            ]
            ...
            if failure_causes:
                ...
                newly_unsatisfied_names = {
                    ...
                    if key in satisfied_names and not self._is_current_pin_satisfying(key, criterion)
                }
