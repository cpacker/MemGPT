...
class ConfigurationCommand(Command):
    ...
    def add_options(self) -> None:
        self.cmd_opts.add_option(
            ...
            action="store",
            default=None,
            help=("Editor to use to edit the file. Uses VISUAL or EDITOR " "environment variables if not provided."),
        )
    ...
    def _get_n_args(self, args: List[str], example: str, n: int) -> Any:
        ...
        if len(args) != n:
            msg = f"Got unexpected number of arguments, expected {n}. " f'(example: "{get_prog()} config {example}")'
            raise PipError(msg)
