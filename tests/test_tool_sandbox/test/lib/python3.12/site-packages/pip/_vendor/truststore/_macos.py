...
try:
    ...
    CoreFoundation.kCFAllocatorDefault = CFAllocatorRef.in_dll(CoreFoundation, "kCFAllocatorDefault")  # type: ignore[attr-defined]
    CoreFoundation.kCFTypeArrayCallBacks = c_void_p.in_dll(CoreFoundation, "kCFTypeArrayCallBacks")  # type: ignore[attr-defined]
...
def _bytes_to_cf_data_ref(value: bytes) -> CFDataRef:  # type: ignore[valid-type]
    return CoreFoundation.CFDataCreate(CoreFoundation.kCFAllocatorDefault, value, len(value))  # type: ignore[no-any-return]
