...
class PythonLexer(RegexLexer):
    ...
    tokens = {
        ...
        "expr-keywords": [
            ...
            (words(("async for", "await", "else", "for", "if", "lambda", "yield", "yield from"), suffix=r"\b"), Keyword),
...
class Python2Lexer(RegexLexer):
    ...
    tokens = {
        ...
        "stringescape": [(r'\\([\\abfnrtv"\']|\n|N\{.*?\}|u[a-fA-F0-9]{4}|' r"U[a-fA-F0-9]{8}|x[a-fA-F0-9]{2}|[0-7]{1,3})", String.Escape)],
        "strings-single": innerstring_rules(String.Single),
        "strings-double": innerstring_rules(String.Double),
        "dqs": [
            (r'"', String.Double, "#pop"),
...
class CythonLexer(RegexLexer):
    ...
    tokens = {
        ...
        "nl": [(r"\n", String)],
        "dqs": [(r'"', String, "#pop"), (r'\\\\|\\"|\\\n', String.Escape), include("strings")],  # included here again for raw strings
        "sqs": [(r"'", String, "#pop"), (r"\\\\|\\'|\\\n", String.Escape), include("strings")],  # included here again for raw strings
...
class DgLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            (r"(?<!\.)(Exception|GeneratorExit|KeyboardInterrupt|StopIteration|" r"SystemExit)(?!['\w])", Name.Exception),
            (r"(?<![\w.])(except|finally|for|if|import|not|otherwise|raise|" r"subclass|while|with|yield)(?!['\w])", Keyword.Reserved),
            (r"[A-Z_]+'*(?!['\w])", Name),
