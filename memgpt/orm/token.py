...
class Token(SqlalchemyBase, UserMixin):
    ...
    _temporary_shim_api_key: Mapped[Optional[str]] = mapped_column(String,
                                                                     ...
                                                                     doc="a temporary shim to get the ORM launched without refactoring downstream")
    ...
    def api_key(self) -> Optional[str]:
        ...
        logger.warning("Token.api_key is a temporary shim to get the ORM launched. It is unsecure, dangerous, and will be replaced by token.authenticate() in the next PR!")
