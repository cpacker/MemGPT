...
def _check_dist_requires_python(
    ...
    raise UnsupportedPythonVersion(
        "Package {!r} requires a different Python: {} not in {!r}".format(dist.raw_name, version, requires_python)
    )
    ...
    def _add_requirement_to_set(
        ...
        if has_conflicting_requirement:
            raise InstallationError(
                "Double requirement given: {} (already in {}, name={!r})".format(install_req, existing_req, install_req.name)
            )
