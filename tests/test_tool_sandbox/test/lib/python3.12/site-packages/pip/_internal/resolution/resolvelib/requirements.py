...
class SpecifierRequirement(Requirement):
    ...
    def is_satisfied_by(self, candidate: Candidate) -> bool:
        assert candidate.name == self.name, f"Internal issue: Candidate is not for this requirement " f"{candidate.name} vs {self.name}"
...
class RequiresPythonRequirement(Requirement):
    ...
    def __eq__(self, other: Any) -> bool:
        if not isinstance(other, RequiresPythonRequirement):
            return False
        return self._specifier_string == other._specifier_string and self._candidate == other._candidate
