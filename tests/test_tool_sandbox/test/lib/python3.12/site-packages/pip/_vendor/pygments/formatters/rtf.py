...
class RtfFormatter(Formatter):
    ...
    def _lineno_template(self):
        if self.lineno_fontsize != self.fontsize:
            return "{{\\fs{} \\cf{} %s{}}}".format(self.lineno_fontsize, self.color_mapping[self.lineno_color], " " * self.lineno_padding)
    ...
    def _rtf_header(self):
        ...
        lines.append(
            "{\\rtf1\\ansi\\uc0\\deff0"
            "{\\fonttbl{\\f0\\fmodern\\fprq1\\fcharset0%s;}}" % (self.fontface and " " + self._escape(self.fontface) or "")
        )
